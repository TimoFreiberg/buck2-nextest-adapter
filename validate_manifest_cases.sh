...
run_case adapter_owned_runtime '{"schema_version":1,"artifact":{"package_name":"buck2-nextest-buck-artifact","binary_id":"buck2_nextest_rust_test","binary_name":"buck2_nextest_rust_test","target_kind":"test","test_cases":["pass_case","fail_case"]},"paths":{"executable":"bin/buck2_nextest_rust_test","working_directory":"work","runtime_inputs":["manifest.json"]},"environment":{"BUCK2_ARTIFACT_RUNTIME":"declared"},"platform":{"target_triple":"x","target_features":"unknown"},"build":{"generated_outputs":[]}}'
