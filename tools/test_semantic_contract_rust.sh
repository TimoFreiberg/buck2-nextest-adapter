...
cat >"$manifest" <<EOF
{"schema_version":2,"records":[{"package_identity":"demo-package","owner_label":"//:demo_tests","binary_identity":"alpha","display_name":"same-display-name","target_kind":"test","executable":{"source":"buck2_nextest_rust_test","kind":"regular_file"},"cwd":"work","platform":"local-fixture-v1"},{"package_identity":"demo-package","owner_label":"//:demo_tests","binary_identity":"beta","display_name":"same-display-name","target_kind":"test","executable":{"source":"buck2_nextest_rust_test_beta","kind":"regular_file"},"cwd":"work","platform":"local-fixture-v1"}]}
EOF
